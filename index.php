...
<head>
    ...
    <title>Bienvenu sur LaboGénétique</title>
			...
			<div class="col-sm-7 col-md-9 col-lg-9 option_lecon" id='c1' style='border:1px solid black; border-radius: 5px;margin-top : 5px;'>
			        ...
			        <div class='row'>
						<div class='col-xs-12 col-sm-12 col-md-5 col-lg-5 mise-en-forme'>
			        		Comment expliquer les ressemblances  observees entre les personnes d'une même famille?
			        		comment se fait la transmission des caractères héréditaires et de l'information génétique
			        		d'une génération à  la suivante?
			        		Comment expliquer la nature et l'expression de l'information génétique?
			        	</div>
			...
			<div class="col-sm-7 col-md-9 option_lecon" id='option_lecon1' style='display:none; border:1px solid black; border-radius: 5px;margin-top : 5px;'>
			        ...
			        <div class='row details_lecon mise-en-forme' id='exo-lecon1' style='display:none;'>
			        	<div class='col-md-12 col-xs-12 col-sm-12 col-lg-12' style='border-radius:1000px;border:1px solid #c0c0c0;'>
			        		<div class='row'>
			        			<div class='col-md-12 col-xs-12 col-sm-12 col-lg-12' style='border-radius:1000px;border:1px solid #c0c0c0;'>
			        				<b>EXERCICES</b> <i style='color:red;'>(Attention rassurez-vous de la bonne réponse avant de cocher)</i>
			        			</div>
			        		</div>
			        	</div>
							  ...
							  <!-- Indicators -->
								  ...
								  <div class="carousel-inner" role="listbox">
									    <div class="item active">
									      	<h3>Réponds par vrai ou faux en cochant la bonne réponse</h3>
											...
											<div class='row quizz-lecon1' id='q2' style='text-align:left;'>
												<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>b.	Un enfant peut ressembler à ses grands-parents</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
											...
											<div class='row quizz-lecon1' id='q3' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>c.	La forme du nez est un caractère héréditaire</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
									    ...
									    <div class="item">
							        		...
							        		<div class='row quizz-lecon1' id='q4' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>d.	Tous les êtres humains appartiennent à la même espèce</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
											...
											<div class='row quizz-lecon1' id='q6' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>f.	L'albinisme n'est pas un caractère héréditaire</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
									    ...
									    <div class="item">
							        		...
							        		<div class='row quizz-lecon1' id='q7' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>g.	Le mariage entre un noir et une personne métissée donne des enfants carterons</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
											  		<label class="radio-inline">
											...
											<div class='row quizz-lecon1' id='q8' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>h.	la science qui étudie l'hérédité s'appelle la génétique</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
											...
											<div class='row quizz-lecon1' id='q9' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>i.	le mariage interracial  donne naissance aux métissées</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
											...
											<div class='row quizz-lecon1' id='q10' style='text-align:left;'>
											  	<div class='col-md-8 col-xs-8 col-sm-8 col-lg-8'>j.	la forme de la bouche n'est pas un caractère héréditaire</div>
                                                <div class='col-md-2 col-xs-2 col-sm-2 col-lg-2'>
                                                    <label class="radio-inline">
			        ...
			        <div class='row details_lecon mise-en-forme' id='lecture-lecon1' style='display:none;'>
			        	<div class='col-md-12 col-xs-12 col-sm-12 col-lg-12'>
			        		<b>Un arbre généalogique : Cliquez sur un des petit-fils pour observer.</b>
			        	</div>
			        	...
			        	<div class='col-md-4 col-xs-12 col-sm-12 col-lg-4 caractere' id='indiv34' style='display:none;height:300px;overflow:auto;'>
			        		...
			        		<div style="color:mediumblue" class="list-group">
							  <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Couleur de yeux :</span> elle hérite des yeux de son père Roger
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme de la bouche :</span> elle l'hérite de sa mère Agnes qui l'hérite de son père Maximilien.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'> elle hérite de son père  Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	   	<span class='phenotype' style='display:block;'>Forme du menton :</span> elle hérite de son père Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme des oreilles :</span> elle les hérite de son père Roger
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Couleur de la peau :</span> elle hérite de sa mère Karine qui elle hérite de son père Bernard
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du visage :</span> un mélange de son père et de sa mère
							  </a>
							</div>
			        	</div>
			        	<div class='col-md-4 col-xs-12 col-sm-12 col-lg-4 caractere' id='indiv31' style='display:none;height:300px;overflow:auto;'>
			        		...
			        		<div style="color:mediumblue" class="list-group">
							  <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Couleur de yeux :</span> Il hérite des yeux de sa mère Agnès qui l'hérite de son père Maxilimien.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme de la bouche :</span> Il l'hérite de son père Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du nez :</span> Il hérite de son père  Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	   	<span class='phenotype' style='display:block;'>Forme du menton :</span> Il hérite de sa mère Agnès qui l'hérite de sa mère Bernadette.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme des oreilles :</span> Il les hérite de son père Roger
							  </a>
							  
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du visage :</span> Il hérite de la forme du visage de sa mère Agnes qui elle l'hérite de sa mère Bernadette
							  </a>
							</div>
			        	</div>
			        	<div class='col-md-4 col-xs-12 col-sm-12 col-lg-4 caractere' id='indiv32' style='display:none;height:300px;overflow:auto;'>
			        		...
			        		<div style="color:mediumblue" class="list-group">
							  ...
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du nez :</span> Elle l'hérite de son père  Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	   	<span class='phenotype' style='display:block;'>Forme du menton :</span> Elle hérite de sa mère Agnès qui l'hérite de sa mère Bernadette.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme des oreilles :</span> Elle les hérite de son père Roger
							  </a>
							  ...
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du visage :</span> Elle hérite de la forme du visage de sa mère Agnes qui elle l'hérite de sa mère Bernadette
							  </a>
							</div>
			        	</div>
			        	<div class='col-md-4 col-xs-12 col-sm-12 col-lg-4 caractere' id='indiv33' style='display:none;height:300px;overflow:auto;'>
			        		...
			        		<div style="color:mediumblue" class="list-group">
							  ...
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme de la bouche :</span> Il l'hérite de sa mère Agnes qui l'hérite de son père Maximilien.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du nez :</span> Il hérite de son père  Roger.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	   	<span class='phenotype' style='display:block;'>Forme du menton :</span> Il hérite de sa mère Agnès qui l'hérite de sa mère Bernatte.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme des oreilles :</span> Il les hérite de son père Roger
							  </a>
			        	...
			        	<div class='col-md-4 col-xs-12 col-sm-12 col-lg-4 caractere' id='indiv36' style='display:none;height:300px;overflow:auto;'>
			        		...
			        		<div style="color:mediumblue" class="list-group">
							  ...
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme de la bouche :</span> Elle l'hérite de sa mère Sidonie.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du nez :</span> Il hérite de son père  Michel qui a hérité de son père Max.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	   	<span class='phenotype' style='display:block;'>Forme du menton :</span> Il hérite de sa mère Sidonie.
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme des oreilles :</span> Il les hérite de sa mère Siodnie
							  </a>
							  
							  <a style="color:mediumblue" href="#" class="list-group-item">
							  	    <span class='phenotype' style='display:block;'>Forme du visage :</span> Il hérite de la forme du visage de sa mère
							  </a>
							</div>
			        	</div>
			        </div>
			...
			<div class="col-sm-7 col-md-9 option_lecon" id='option_lecon2' style='display:none; border:1px solid black; border-radius: 5px;margin-top : 5px;'>
			        ...
			        <div class='row details_lecon detail'>
			        	<div class='col-md-6 col-xs-6 col-sm-12'><br>
                            ...
                            <a href='#' class='btn btn-info btn-large btn-block' id='btn-protocol-lecon2'>Protocole expérimental <img src='bootstrap/img/ico-etudier.png'/></a>
			        		<a href='laboratoire.php' class='btn btn-warning btn-large btn-block' title="Réalisation d'un caryotype">Experiences <img src='bootstrap/img/ico-revision.png'/></a>
			        	</div>
			        	<div class='col-md-6 col-xs-6 col-sm-12'>
			        	...
			        	<div class='col-md-12 col-xs-12 col-sm-12 col-lg-12 mise-en-forme'>
			        		<div id="myCarousel2" class="carousel slide" data-ride="carousel">
							  <!-- Indicators -->
								  ...
								  <div class="carousel-inner" role="listbox">
									    <div class="item active">
									      	<h3>Parmi les affirmations suivantes, relève celles qui sont exactes.</h3>
							        		<span id='q1'>1.	Le caryotype d'une cellule male est différent de celui d'une cellule femelle au niveau de</span>
									    ...
									    <div class="item">
											<span id='q2'>2.	Un individu souffrant du syndrome de trisomie 21 possède</span>
									   ...
									   <div class="item">
											...
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  &emsp;&emsp;&emsp;&emsp;<label><input type="radio" name="optradio" class='q3 trueAns 1'>b.	Féminin</label>
											</div>
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  &emsp;&emsp;&emsp;&emsp;<label><input type="radio" name="optradio" class='q3 falseAns 1'>c.	Masculin et féminin</label>
											</div>
									    </div>
									    ...
									    <div class="item">
											...
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  &emsp;&emsp;&emsp;&emsp;<label><input type="radio" name="optradio" class='q4 falseAns 1'>b.	Féminin</label>
											</div>
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  &emsp;&emsp;&emsp;&emsp;<label><input type="radio" name="optradio" class='q4 falseAns 1'>c.	Masculin et féminin</label>
											</div>
									    </div>
									    <div class="item">
											<span id='q5'>5. Un individu atteint du syndrome de klinefelter possède dans son caryotype</span>
									    ...
									    <div class="item">
											<span id='q6'>6. Pour arrêter la division cellulaire on utilise comme colorant :</span>
											...
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  &emsp;&emsp;&emsp;&emsp;<label><input type="radio" name="optradio" class='q6 falseAns 1'>c.	Le méthyl de propylène </label>
											</div>
									    </div>
									    <div class="item">
											...
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q7 falseAns 1'>b.	Ne sont présents dans le noyau que lorsque la cellule se divise</label>
											</div>
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q7 trueAns 1'>c.	Sont toujours présents, mais ne sont facilement visibles que lorsque la cellule se divise</label>
											</div>
									    </div>
									    <div class="item">
											<span id='q8'>8.	Dans l'espèce humaine, le caryotype comporte :</span>
											...
											<div class="radio quizz-lecon2" style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q8 trueAns 1'>c.	Quarante-six chromosomes dont un seul différent chez l'homme et chez la femme</label>
											</div>
									    </div>
                            ...
                            <div style="color:mediumblue" class="list-group">
							  <a style="color:mediumblue" href="#" class="list-group-item">
                                    ...
                                    <div style="text-align:left;">
                                        ...
                                        <b>&rarr;</b> Deposer dans le tube à essai <img style='height:25px;' src='bootstrap/img/icones/tube_essai_vide_gr.png'/> le sang contenu dans la pipette </br>
                                    </div>
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Etape 2 : Obtenir des métaphases</span> 
                                    <div style="text-align:left;">
                                        ...
                                        <b>&rarr;</b> Ajouter dans le tube à essai <img style='height:25px;' src='bootstrap/img/icones/tube_essai_rouge_gr0.png'/> la colchicine contenue dans la pipette. (Ceci a pour effet de bloquer la division cellulaire au stade de métaphase)</br>
                                        ...
                                        <b>&rarr;</b> Ajouter dans le tube à essai <img style='height:25px;' src='bootstrap/img/icones/tube_essai_rouge_gr1.png'/> le critale violet contenu dans la pipette (pour la coloration des chromosomes)</br>
                                    </div>
							  </a>
                              <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Etape 3 : Identification des chromosomes</span> 
                                    <div style="text-align:left;">
                                    	<b>&rarr;</b>A l'aide de l'outil pipette <img style='height:20px;' src='bootstrap/img/icones/pipette.png'/> prenez une goutte du mélange contenu dans le tube à essai <img style='height:25px;' src='bootstrap/img/icones/tube_essai_violet_gr.png'/></br>
                                        <b>&rarr;</b> Déposer ce melange sur la lame <img style='height:25px;' src='bootstrap/img/icones/lame_grand.png'/> </br>
                                        <b>&rarr;</b>Déposer la lame sur le microscope optique puis filmer le résultat  <img style='height:25px;' src='bootstrap/img/icones/capture.png'/></br>
                                        <b>&rarr;</b> Ajouter dans le tube à essai <img style='height:25px;' src='bootstrap/img/icones/tube_essai_rouge_gr1.png'/> le critale violet contenu dans la pipette (pour la coloration des chromosomes)</br>
                                    </div>
							  </a>
                              <a style="color:mediumblue" href="#" class="list-group-item">
                                    ...
                                    <div style="text-align:left;">
                                    	<b>&rarr;</b> Dans l'image obtenue, vous observez des chromosomes éparpillés. Sélectionnez-les un à un pour les ranger par paire homologue dans le tableau de caryotype</br>
                              ...
                              <a style="color:mediumblue" href="#" class="list-group-item">
                                    ...
                                    <div style="text-align:left;">
                                    	<b>&rarr;</b> Parmis les types de caryotypes proposés cochez celui qui correspond à cette cellule</br>
                                    </div>
							  </a>
                           </div>
                        </div>
			...
			<div class="col-sm-7 col-md-9 option_lecon" id='option_lecon3' style='display:none; border:1px solid black; border-radius: 5px;margin-top : 5px;'>
			        ...
			        <div class='row details_lecon detail'>
			        	<div class='col-md-6 col-xs-6 col-sm-12'><br>
                            ...
                            <a href='#' class='btn btn-default btn-large btn-block' id='btn-protocol-lecon3'>Protocole expérimental <img src='bootstrap/img/ico-etudier.png'/></a>
			        		<a href='labo2.php' class='btn btn-info btn-large btn-block' title="Détermination de groupes sanguins par la méthode de Beth-Vincent (utilisation de Sérum)">Experiences 1<img src='bootstrap/img/ico-revision.png'/></a>
			        		<a href='labo3.php' class='btn btn-warning btn-large btn-block' title="Détermination de groupes sanguins par la méthode de Simonin (Utilisation d'hématies)">Experiences 2<img src='bootstrap/img/ico-revision.png'/></a>
			        	</div>
			        	<div class='col-md-6 col-xs-6 col-sm-12'>
			        		...
			        		<div id="myCarousel3" class="carousel slide" data-ride="carousel">
							  <!-- Indicators -->
								  ...
								  <div class="carousel-inner" role="listbox">
									    <div class="item active">
									      	<h3>Parmi les affirmations suivantes, relève celles qui sont exactes.</h3>
							        		<span id='q1'>1.	Les gènes sont</span>
							        		
							        		<div class="radio quizz-lecon3"  style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q1 trueAns 2'>a.	Des unités d'information situées au même endroit sur les deux chromosomes d'une même paire</label>
											</div>
											<div class="radio quizz-lecon3"  style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q1 falseAns 2'>b.   Des unités d'information rigoureusement identique sur les deux chromosomes   d'une même paire ;</label>
											</div>
											<div class="radio quizz-lecon3"  style='text-align:left;'>
											  <label><input type="radio" name="optradio" class='q1 falseAns 2'>c.	Des versions différentes d'un même allèle</label>
											</div>
									    ...
									    <div class="item">
									      	<h3>Parmi les affirmations suivantes, relève celles qui sont exactes.</h3>
							        		<span id='q3'>3.	Parmi les groupes sanguins quel est celui qui agglutine avec le sérum anti A</span>
									    ...
									    <div class="item">
									      	<h3>Parmi les affirmations suivantes, relève celles qui sont exactes.</h3>
							        		<span id='q4'>4.	Parmi les groupes sanguins quel est celui qui agglutine en présence du sérum anti B</span>
									    ...
									    <div class="item">
									      	<h3>Parmi les affirmations suivantes, relève celles qui sont exactes.</h3>
							        		<span id='q5'>5.	La paire de chromosomes portant le gène responsable du groupe sanguin est :</span>
                    ...
                    <div class='row details_lecon mise-en-forme' id='protocol-lecon3' style='display:none;' align='left'>
			        	<div class='col-md-12 col-xs-12 col-sm-12 col-lg-12' style='height:400px;overflow:auto;'>
                            ...
                            <div style="color:mediumblue" class="list-group">
							  <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Etape 1 : Prélever du sang sang</span> 
                                    <div style="text-align:left;">
                                    	Tout d'abord rassurez-vous que vous portez une blouse.</br> 
                                        <b>&rarr;</b> A l'aide de l'outil pipette <img style='height:20px;' src='bootstrap/img/icones/pipette.png'/> prenez du sang <img  src='bootstrap/img/icones/sang.png'/> que vous déposerez sur chacune des lames <img style='height:25px;' src='bootstrap/img/icones/lame_grand2.png'/></br>
                                    </div>
							  </a>
							  <a style="color:mediumblue" href="#" class="list-group-item">
									<span class='phenotype' style='display:block;'>Etape 2 : Ajouter des serums</span> 
                                    <div style="text-align:left;">
                                    	<b>&rarr;</b> A l'aide de l'outil pipette <img style='height:20px;' src='bootstrap/img/icones/pipette.png'/> prenez une goutte de serum anti-A et déposer sur une lame </br>
                                        <b>&rarr;</b> Prenez une goutte de serum anti-B et déposer sur une autre lame </br>
                                        <b>&rarr;</b> Prenez une goutte de serum anti-AB et déposer sur une lame differente des autres</br>
                                        <b>&rarr;</b> Enfin déposer une goute de serum anti-D ou anti-Rhésus su la dernière lame</br>
                                    </div>
							  </a>
                              <a style="color:mediumblue" href="#" class="list-group-item">
                              ...
                              <a style="color:mediumblue" href="#" class="list-group-item">
                                    ...
                                    <div style="text-align:left;">
                                    	<b>&rarr;</b> S'il y a agglutination sur la lame contenant le serum anti-D alors le rhésus est positif. Sinon le rhésus est négatif </br>
								  ...
								  <div class="carousel-inner" role="listbox">
									    ...
									    <div class="item">
											...
											<div class='quizz-lecon4' id='q9' style='text-align:left;'>
											  	1.	Soit un couple où: <br>
												-	la femme possède en double exemplaire l'allèle dirigeant la synthèse d'une hémoglobine normale noté  A.<br>
